...
include_once('db/database_credentials.php');
        ...
        <div class="section-container tabs" data-section>
          <section class="section">
            <div class="content" data-slug="panel1">
              ...
              <td><a href="./add.php" class="button radius tiny success">Agregar nuevo registro</a></td>
              <?php if($total_users){ ?>
              <table>
                <thead>
                  <tr>
                ...
                <tbody>
                  <?php 
                  while($r = $user_access->fetch(PDO::FETCH_ASSOC)) { ?>
                  ...
                  <tr>
                    ...
                    <td><a href="update.php?id=<?= $r['id']; ?>" class="button radius tiny warning"">Modificar</a></td>
                    <td><a href="delete.php?id=<?=$r['id']?>" class="button radius tiny alert"">Eliminar</a></td>
                  </tr>
                  <?php } ?>
                  <tr>
